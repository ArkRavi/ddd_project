...
class _$_Failed<T> extends _Failed<T> {
  ...
  @override
  String toString() {
    return 'RemoteResponse<$T>.failed()';
  }
...
abstract class _Failed<T> extends RemoteResponse<T> {
...
abstract class _WithData<T> extends RemoteResponse<T> {
  const factory _WithData(T data) = _$_WithData<T>;
